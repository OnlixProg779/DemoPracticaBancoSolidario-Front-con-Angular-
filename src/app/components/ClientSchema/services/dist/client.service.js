...
var API_URL = environment_1.environment.apiURLMicroserviceClient + '/api/0v1/Client';
var ClientService = /** @class */ (function (_super) {
    ...
    ClientService.prototype.registerNewClient = function (request) {
        var headers = new http_1.HttpHeaders({
            'Content-Type': environment_1.environment.mediaTypes.client.post.ContentType.postJson
        });
    ...
    ClientService.prototype.getAllClients = function (params) {
        var headers;
        var eTag;
        eTag = localStorage.getItem('If-None-Match-get------');
        headers = new http_1.HttpHeaders({
            'Content-Type': 'application/json',
            Accept: environment_1.environment.mediaTypes.client.getAll.accept.getAllclientJson,
            'If-None-Match': "\"" + eTag + "\""
        });
        return this.http
    ...
    ClientService.prototype.getUniqueClient = function (id, params) {
        var headers;
        var eTag;
        eTag = localStorage.getItem('If-None-Match-get------');
        headers = new http_1.HttpHeaders({
